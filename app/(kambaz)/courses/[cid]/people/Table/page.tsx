        ...
        <tbody>
          <tr>
            ...
            <td className="wd-full-name text-nowrap">
              ...
              <span className="wd-last-name">Murphy</span>
            </td>
            <td className="wd-login-id">001234231S</td>
            <td className="wd-section">S101</td>
            <td className="wd-role">STUDENT</td>
            ...
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
              <span className="wd-first-name">Jared</span>{" "}
              <span className="wd-last-name">Jones</span>
            </td>
            <td className="wd-login-id">001256721S</td>
            <td className="wd-section">S101</td>
            <td className="wd-role">STUDENT</td>
