...
export default function TOC() {
 ...
 return (
   <Nav variant="pills">
     ...
     <NavItem>
       <NavLink href="https://github.com/ABuisir10">My GitHub</NavLink></NavItem>
     <NavItem>
       <NavLink href="https://github.com/ABuisir10/kambaz-node-server-app">Node Server App</NavLink></NavItem>
     <NavItem>
       <NavLink href="https://kambaz-node-server-app-ts66.onrender.com">Server</NavLink></NavItem>
   </Nav>
 );}
